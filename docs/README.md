...
- **[Sistema de Exportación](exports-system.md)**: Documentación técnica completa del sistema de exportación de datos, incluyendo exportación de Convocatorias y Resoluciones a Excel, filtros aplicados, formateo de datos, autorización, traducciones, y guía de uso con ejemplos.
