    ...
    */
    ...
    'options' => [
        ...
        'db' => [
            ...
            'hints' => env('DEBUGBAR_OPTIONS_DB_HINTS', true),          // Show hints for common mistakes (N+1, etc.)
            'show_copy' => env('DEBUGBAR_OPTIONS_DB_SHOW_COPY', true),       // Show copy button next to the query,
            'only_slow_queries' => env('DEBUGBAR_OPTIONS_DB_ONLY_SLOW_QUERIES', false), // Track ALL queries for N+1 detection
            'slow_threshold' => env('DEBUGBAR_OPTIONS_DB_SLOW_THRESHOLD', 100), // Highlight queries over 100ms
            ...
            'hard_limit' => (int) env('DEBUGBAR_OPTIONS_DB_HARD_LIMIT', 1000),  // After the hard limit, queries are ignored
        ],
        'mail' => [
