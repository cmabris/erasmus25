<div>
        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                    {{ __('Añade una nueva convocatoria Erasmus+ al sistema') }}
                </p>
            </div>
            <flux:button 
                ...
                <div class="space-y-6">
                    ...
                    <x-ui.card>
                        <div class="space-y-6">
                            ...
                            <flux:field>
                                <flux:label>{{ __('Estado Inicial') }}</flux:label>
                                ...
                                <flux:description>{{ __('Estado inicial de la convocatoria') }}</flux:description>
                                @error('status')
                                    <flux:error>{{ $message }}</flux:error>
                                @enderror
                            </flux:field>
    ...
    {{-- Toast Notifications --}}
    <x-ui.toast event="call-created" variant="success" />
</div>
