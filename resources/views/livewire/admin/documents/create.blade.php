<div>
        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                    {{ __('Añade un nuevo documento al sistema') }}
                </p>
            </div>
            <flux:button 
                    ...
                    <x-ui.card>
                        <div class="mb-4">
                            ...
                            <flux:text class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                                {{ __('Sube el archivo del documento (opcional pero recomendado)') }}
                            </flux:text>
                        </div>
                        <div class="space-y-4">
                            <flux:field>
                                <flux:label>{{ __('Seleccionar archivo') }}</flux:label>
    ...
    {{-- Toast Notifications --}}
    <x-ui.toast event="document-created" variant="success" />
</div>
