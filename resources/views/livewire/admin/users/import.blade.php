        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                    {{ __('Importa usuarios desde un archivo Excel o CSV') }}
                </p>
            </div>
            <flux:button 
        ...
        <x-ui.card>
            <div class="mb-4">
                ...
                <flux:description class="mt-2">
                    {{ __('Selecciona un archivo Excel (.xlsx, .xls) o CSV (.csv) con los usuarios a importar. Puedes descargar una plantilla para ver el formato requerido.') }}
                </flux:description>
            </div>
            ...
            <div class="space-y-6">
                ...
                <flux:field>
                    <flux:checkbox wire:model="sendEmails" />
                    <flux:label>{{ __('Enviar Emails con Contraseñas Generadas') }}</flux:label>
                    <flux:description>
                        {{ __('Si está activado, se enviarán emails a los usuarios con contraseñas generadas automáticamente. (Funcionalidad pendiente de implementar)') }}
                    </flux:description>
                </flux:field>
        ...
        <div class="mt-6 animate-fade-in" style="animation-delay: 0.2s;">
            <x-ui.card>
                ...
                <div class="space-y-6">
                    ...
                    {{-- Users with Generated Passwords --}}
                    @if(!empty($results['users_with_passwords']))
                        <div>
                            <flux:callout variant="info">
                                <flux:callout.heading>
                                    {{ __('Contraseñas Generadas Automáticamente') }}
                                </flux:callout.heading>
                                <flux:callout.text>
                                    {{ __('Los siguientes usuarios tienen contraseñas generadas automáticamente. Guarda esta información de forma segura:') }}
                                </flux:callout.text>
                            </flux:callout>
                            <div class="mt-4 overflow-x-auto">
                                <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                                    ...
                                    <tbody class="divide-y divide-zinc-200 bg-white dark:divide-zinc-700 dark:bg-zinc-900">
                                        @foreach($results['users_with_passwords'] as $item)
                                            <tr>
                        ...
                        <flux:callout variant="success">
                            ...
                            <flux:callout.text>
                                {{ $results['dry_run'] 
                                    ...
                                    : __('Todos los usuarios se importaron correctamente.') }}
                            </flux:callout.text>
                        </flux:callout>
                    @endif
                </div>
