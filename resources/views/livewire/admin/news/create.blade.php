<div>
        ...
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                    {{ __('Añade una nueva noticia o experiencia Erasmus+ al sistema') }}
                </p>
            </div>
            <flux:button 
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <x-ui.card>
                        <div class="mb-4">
                            ...
                            <flux:text class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                                {{ __('Sube una imagen destacada para la noticia (opcional)') }}
                            </flux:text>
                        </div>
                        <div class="space-y-4">
                            <flux:field>
    ...
    {{-- Toast Notifications --}}
    <x-ui.toast event="news-post-created" variant="success" />
