@props([
    'simple' => false, // Simple footer without full content
])

<footer {{ $attributes->merge(['class' => 'bg-zinc-900 dark:bg-zinc-950']) }}>
    @if(!$simple)
            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    <a href="{{ route('home') }}" class="flex items-center gap-3" wire:navigate>
                        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-erasmus-500 to-erasmus-600 text-white">
                            <span class="text-lg font-bold">E+</span>
                        </div>
                        <div>
                            <p class="text-base font-semibold text-white">Erasmus+</p>
                            <p class="text-xs text-zinc-400">Centro Murcia</p>
                        </div>
                    </a>
                    ...
                    <div class="mt-6 flex gap-4">
                        <a href="#" class="text-zinc-400 transition-colors hover:text-white" aria-label="Twitter">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                            </svg>
                        </a>
                        <a href="#" class="text-zinc-400 transition-colors hover:text-white" aria-label="Facebook">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                            </svg>
                        </a>
                        <a href="#" class="text-zinc-400 transition-colors hover:text-white" aria-label="Instagram">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="text-zinc-400 transition-colors hover:text-white" aria-label="YouTube">
                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="mt-6">
                        <div class="flex items-center gap-3 rounded-lg bg-zinc-800 p-3">
                            <div class="flex h-8 w-12 items-center justify-center rounded bg-[#003399]">
        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
                <p class="text-sm text-zinc-400">
                    © {{ date('Y') }} Erasmus+ Centro Murcia. {{ __('Todos los derechos reservados.') }}
                </p>
